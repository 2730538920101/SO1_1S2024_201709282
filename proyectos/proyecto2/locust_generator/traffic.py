...
class readFile():
    ...
    def loadFile(self):
        print("Cargando ...")
        try:
            response = requests.get("https://my.api.mockaroo.com/bands.json?key=fcdd61c0")
            if response.status_code == 200:
                ...
                print("Error al cargar los datos de Mockaroo. Código de estado:", response.status_code)
